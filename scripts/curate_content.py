...
## ΚΑΝΟΝΕΣ ΕΠΙΛΟΓΗΣ
- ΑΠΟΚΛΕΙΣΕ: θανάτους, πόλεμο, εγκλήματα, διαφθορά, σκάνδαλα, φυσικές καταστροφές, οικονομικές κρίσεις, ατυχήματα, ΑΘΛΗΤΙΣΜΟ (ποδόσφαιρο, μπάσκετ, Euroleague, πρωταθλήματα, αγώνες, σκορ, μεταγραφές)
